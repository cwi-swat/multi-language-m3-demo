...
public class Doors {
  ...
  private void dispatch$opened(String $token) {
     System/*src: |project://multi-language-m3-demo/src/doors/Doors.jstm|(331,6,<19,4>,<19,10>) */.out/*src: |project://multi-language-m3-demo/src/doors/Doors.jstm|(338,3,<19,11>,<19,14>) */.println/*src: |project://multi-language-m3-demo/src/doors/Doors.jstm|(342,7,<19,15>,<19,22>) */("We're opened now");
